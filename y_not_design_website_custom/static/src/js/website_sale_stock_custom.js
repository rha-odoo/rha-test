odoo.define('y_not_design_website_sale_stock.ProductConfiguratorMixin', function (require) {
'use strict';
...
VariantMixin._onChangeCombinationStock = function (ev, $parent, combination) {
    ...
    var max_qty = $parent.find('input[name="max_qty"]').val();
    ...
    if (combination.product_type === 'product' && _.contains(['always', 'threshold'], combination.inventory_availability)) {
        ...
        if(this.isWebsite){
            combination.virtual_available = max_qty - parseInt(combination.cart_qty);
        }
